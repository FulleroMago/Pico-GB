...
// uint16_t ili9341_pinCS = TFT_CS;
// uint16_t ili9341_pinDC = TFT_DC;
// int16_t ili9341_pinRST = TFT_RST;

// uint16_t ili9341_pinSCK = TFT_SCLK;
// uint16_t ili9341_pinTX = TFT_MOSI;

uint16_t ili9341_pinCS = 0;
uint16_t ili9341_pinDC = 0;
int16_t ili9341_pinRST = 0;

uint16_t ili9341_pinSCK = 0;
uint16_t ili9341_pinTX = 0;
